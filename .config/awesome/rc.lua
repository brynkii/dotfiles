...
globalkeys = gears.table.join(
	...
	end, { description = "open geany", group = "launcher" }),

	awful.key({ modkey }, "space", function()
		awful.util.spawn("rofi -show drun -modi drun -line-padding 4 -hide-scrollbar -show-icons")
	end, { description = "rofi menu", group = "launcher" }),
	...
	end, { description = "select screenshot", group = "launcher" }),
...
awful.rules.rules = {
	...
	-- Add titlebars to normal clients and dialogs
	{
		...
		properties = {
			titlebars_enabled = false --[[default = true]],
		},
	},

	-- Set Gimp to always map on the tag named "7" on screen 1.
	{ rule = { class = "Gimp" }, properties = { screen = 1, tag = "7" } },
